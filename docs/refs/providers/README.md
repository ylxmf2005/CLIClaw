...
- Claude Code CLI reference: `docs/refs/providers/claude-code-cli.md`
- Codex CLI reference: `docs/refs/providers/codex-cli.md`
- Manual experiments: `docs/experiments/provider-clis/manual-experiments.md`
